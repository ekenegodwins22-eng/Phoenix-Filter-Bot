...
mydb = my_client["phoenix_referal_user"]
...
class Database:
    ...
    def __init__(self, uri, database_name):
        ...
        self.col = self.db.phoenix_users
        self.grp = self.db.phoenix_groups
        self.users = self.db.phoenix_uersz
        self.bot = self.db.phoenix_clone_bots
