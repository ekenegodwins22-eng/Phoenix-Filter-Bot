...
async def share_text(client, message):
    phoenix = await client.ask(chat_id = message.from_user.id, text = "Now Send me your text.")
    if phoenix and (phoenix.text or phoenix.caption):
        input_text = phoenix.text or phoenix.caption
    else:
        await phoenix.reply_text(
