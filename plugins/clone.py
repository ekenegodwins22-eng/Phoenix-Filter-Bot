...
# Subscribe YouTube Channel For Amazing Bot https://youtube.com/@iyanuanjorindamilola
...
async def clone_menu(client, message):
    ...
    try:
        ...
        await msg.edit_text(f"⚠️ <b>Bot Error:</b>\n\n<code>{e}</code>\n\n**Kindly forward this message to @ph0enix_web to get assistance.**")
